...
monitor and its Alpha 6 graphical projection. It names product requirements,
...
| Presentation | Reviewed columns with clickable natural-order indicators, sorting, grouping, dense/balanced/wide layout, default/contrast/mono theme | Every visible table column maps to an exact native sort allowlist; unknown and conflicting input fails closed |
