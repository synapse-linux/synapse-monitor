...
| Area | Alpha 2 content | Safety treatment |
|---|---|---|
...
| Performance | Aggregate CPU, logical CPUs, RAM, optional GPU/VRAM, physical disks, network interfaces, 60-sample history | Local bounded counters; unavailable is distinct from zero; no telemetry |
